task :set_defaults do
  ...
  set_default :express_log,       "#{logs_path}/production.log"

  set_default :upstart_symlink,   "#{app_sys_id!}.conf"
  set_default :upstart_conf,      "/etc/init/#{upstart_symlink}"
  set_default :upstart_log,       "/var/log/#{app_sys_id}.log"

  set_default :systemd_symlink,   "#{app_sys_id!}.service"
  set_default :systemd_service,   "/etc/systemd/system/#{systemd_symlink}"
